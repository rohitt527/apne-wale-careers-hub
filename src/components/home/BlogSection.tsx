...
import { ArrowRight, BookOpen, TrendingUp, Eye, Clock, User, Star, Sparkles, PenTool } from "lucide-react";
  ...
  return (
    <section className="py-32 bg-gradient-to-b from-white to-gray-50/50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 right-20 w-64 h-64 bg-gradient-to-r from-orange-100/40 to-red-100/40 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 left-20 w-80 h-80 bg-gradient-to-r from-yellow-100/40 to-orange-100/40 rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>

      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-24 animate-fade-in">
          <div className="inline-flex items-center gap-3 bg-white/80 backdrop-blur-sm text-orange-700 px-8 py-4 rounded-full text-sm font-semibold mb-8 border border-orange-100 shadow-lg">
          ...
          {featuredBlogs.map((post, index) => (
            ...
            >
              ...
              <div className="p-10">
                ...
                <Button asChild className={`w-full bg-gradient-to-r ${post.gradient} hover:shadow-xl transition-all duration-500 rounded-2xl py-6 text-lg font-semibold shadow-lg`}>
        ...
        <div className="text-center animate-fade-in">
          <Button size="lg" variant="outline" className="border-2 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white px-16 py-6 text-xl font-semibold shadow-xl hover:shadow-orange-500/25 transition-all duration-500 hover:scale-105 rounded-2xl">
